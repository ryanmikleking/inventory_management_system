...
// import { getLocalSubmissionByIndex } from "../../utility/localStorage";
import "./ItemPreview.css";
import { FaEdit } from "react-icons/fa";

const ItemPreview = ({ setView, keyValue }) => {
  ...
  // const indexData = getLocalSubmissionByIndex(keyValue);
  // console.log(indexData.images);
  const handleSubmit = () => {
